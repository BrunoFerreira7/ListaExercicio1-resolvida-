...
let idadeEmAno = (idadeAgr,anoAgr,anoDesejado) => {     
        for (i = anoAgr; i < anoDesejado; i++) { 
                idadeAgr++;
        }
        return idadeAgr; 
};
// Q2.C) Use essa função para calcular sua idade em 2030 e imprimir `Em 2030, eu terei IDADE EM 2030 anos.`, com a idade correta.
console.log(`Em 2030, eu terei ${idadeEmAno(20,2025,2030)} anos`)
...
let mostrarAnosEIdade = (idadeAgr, anoAgr, anoDesejado) => {
...
mostrarAnosEIdade(20,2025,2035);
